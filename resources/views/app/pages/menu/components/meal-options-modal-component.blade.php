    ...
    <div class="modal-body">
        ...
        @foreach ($meal->optionsGroups as $optionGroup)
            @if ($optionGroup->mealOptions->count())
                ...
                <div class="mb-3">
                    @if ($optionGroup->type == \Resto2web\Core\Domain\Meals\Models\MealOptionGroup::OR)
                    ...
                    @elseif ($optionGroup->type == \Resto2web\Core\Domain\Meals\Models\MealOptionGroup::AND)
                        @foreach ($optionGroup->mealOptions as $mealOption)
